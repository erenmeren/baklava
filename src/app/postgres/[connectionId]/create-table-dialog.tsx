    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-5">
          <DialogSection label="Identity" tone="indigo">
          ...
          >
            <div className="space-y-1.5">
              <div className="grid grid-cols-[12px_1fr_1fr_52px_1fr_42px_24px] gap-1.5 px-1 text-[9.5px] font-mono uppercase tracking-[0.16em] text-muted-foreground/70">
                <span></span>
                <span>Name</span>
                <span>Type</span>
              ...
              <div className="space-y-1 rounded-lg border border-border/40 bg-card/40 p-1.5">
                {columns.map((c, i) => (
                  <div
                    key={i}
                    className="group grid grid-cols-[12px_1fr_1fr_52px_1fr_42px_24px] items-center gap-1.5 rounded-md px-1 py-1 transition-colors hover:bg-foreground/[0.03]"
                  >
                    <span
                ...
                <button
                  type="button"
                  onClick={addColumn}
                  className="flex w-full items-center justify-center gap-1.5 rounded-md border border-dashed border-border/50 px-2 py-1.5 text-[11px] font-mono uppercase tracking-[0.12em] text-muted-foreground transition-colors hover:border-indigo-500/40 hover:bg-indigo-500/[0.04] hover:text-indigo-500"
                >
              ...
              <p className="px-1 text-[10.5px] leading-relaxed text-muted-foreground/80">
                ...
                ,{" "}
                <span className="font-mono text-foreground/70">now()</span>,{" "}
                <span className="font-mono text-foreground/70">
                  gen_random_uuid()
                </span>
          ...
          <DialogSection label="Options" tone="indigo">
            <label
