import type { ObjectProvider } from "./object-providers";
...
export const postgresProvider: ObjectProvider = async (id, query, { pathname, signal }) => {
...
export const mysqlProvider: ObjectProvider = async (id, query, { pathname, signal }) => {
...
export const sqlserverProvider: ObjectProvider = async (id, query, { pathname, signal }) => {
