...
//
// Connection plumbing (`getMysql2` / `withConn` / `query`) lives in
// `mysql-internal.ts`, shared with `mysql-constraints.ts` and deliberately
// not re-exported — the same convention Phase 1 gave the split drivers.
// ─────────────────────────────────────────────────────────────────────────────
